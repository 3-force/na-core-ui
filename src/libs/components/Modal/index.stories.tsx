...
const meta: Meta<typeof Modal> = {
  title: 'Components/UIElements/Modal',
  component: Modal,
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          'Modal is a component that displays content overlaying the main content. It is commonly used for dialogs, alerts, or forms that require user interaction.',
      },
    },
  },
  argTypes: {
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'The Modal component is used to display content that overlays the main content of the page. It can be used for dialogs, alerts, or forms that require user interaction. The modal can be customized with different sizes and placements.',
      },
    },
  },
}
...
export const Sizes: Story = {
  render: () => {
    ...
    return (
      <div className="flex flex-wrap gap-2">
        <button
          data-modal-target="extraSmallModal"
          type="button"
          className="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"
          onClick={extraSmallToggle}
        >
          Extra Small Modal
        </button>

        <Modal
          show={extraSmallModal}
          onHide={extraSmallToggle}
          id="extraSmallModal"
          modal-center="true"
          className="fixed flex flex-col transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4"
        ...
        <button
          data-modal-target="extraLargeModal"
          type="button"
          className="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:focus:ring-custom-400/20"
        ...
        <button
          data-modal-target="fullScreenModal"
          type="button"
          className="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:focus:ring-custom-400/20"
