...
module.exports = {
  ...
  plugins: [
    require('./src/libs/plugins/headings.js'),
    require('./src/libs/plugins/buttons.js'),
    require('./src/libs/plugins/forms.js'),
    require('./src/libs/plugins/card.js'),
    require('./src/libs/plugins/drawer.js'),
    require('./src/libs/plugins/flatpicker.js'),
    require('./src/libs/plugins/simplebar.js'),
    require('./src/libs/plugins/swiper.js'),
    require('./src/libs/plugins/toastify.js'),
    require('./src/libs/plugins/dropzone.js'),
    require('./src/libs/plugins/ckeditor.js'),
    require('./src/libs/plugins/apexcharts.js'),
    require('./src/libs/plugins/maps.js'),
    require('./src/libs/plugins/fullcalendar.js'),
    require('./src/libs/plugins/lightbox.js'),
    require('./src/libs/plugins/prismjs.js'),
    require('./src/libs/plugins/apps.js'),
  ],
}
